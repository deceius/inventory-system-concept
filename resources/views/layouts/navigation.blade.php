                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-ui.nav.dropdown :active="request()->routeIs('admin.*')">
                        ...
                        <x-slot:content>
                            ...
                            <x-ui.dropdown.item :href="route('admin.branch.index')" :active="request()->routeIs('admin.branch.*')">
                                {{ __('Branch Master Data') }}
                            </x-ui.dropdown.item>
                            </form>
                        </x-slot>
                    </x-ui.nav.dropdown>
                ...
                <x-ui.dropdown.link align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div>{{ Auth::user()->name }} {{ Auth::user()->branch ? ' | ' . Auth::user()->branch->name : ''}}</div>
                            <div class="ml-1">
                    ...
                    <x-slot:content>
                        ...
                        <x-ui.dropdown.version></x-ui.dropdown.version>
                    </x-slot>
                </x-ui.dropdown.link>
            </div>
