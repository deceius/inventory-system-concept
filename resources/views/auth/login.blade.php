<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-ui.form.input.text id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-ui.button type="submit" class="ml-3" text="{{ __('Log in') }}">
            </x-ui.button>
        </div>
    </form>
</x-guest-layout>
