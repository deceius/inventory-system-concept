                ...
                <x-slot name="content">
                    <form method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div>
                            ...
                            <x-ui.input.text id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-ui.input.text id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required/>
