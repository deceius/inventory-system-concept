<x-app-layout>
    ...
    <div class="py-12" x-data="branchIndex" x-init="loadBranches()">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                <template x-for="item in data">
                    <x-ui.card ::class="{ 'bg-gray-300' : !item.is_active }">
                        <x-slot name="title" ::class="{ 'text-slate-400' : !item.is_active }">
                        ...
                        <x-slot name="content" ::class="{ 'text-slate-400' : !item.is_active }">
                            <div class="space-y-2">
